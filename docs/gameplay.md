...
- The game **auto-saves** to `localStorage` every 30 seconds.
- Progress is preserved across browser refreshes.
- There is currently no manual save or multiple save slots.
