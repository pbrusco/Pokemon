...
export function buildNPCDatabase(
  ...
  return {
    ...
    PEWTER_GYM: [
      { id: 'gym_trainer', name: 'ENTRENADOR GYM', type: 'npc', position: { x: 4, y: 7 }, direction: 'down', trainerClass: 'hiker', dialogue: ["¡Para llegar a BROCK tendrás que vencerme!", "¡Mis POKÉMON son duros!"], isTrainer: true, trainerTeam: [makePokemon('diglett', 'DIGLETT', 9, 'ground', [MOVES.SCRATCH, MOVES.GROWL], 255, { types: ['ground'] }), makePokemon('sandshrew', 'SANDSHREW', 9, 'ground', [MOVES.SCRATCH, MOVES.GROWL], 255, { types: ['ground'] })] },
    ...
    CERULEAN_GYM: [
      { id: 'swimmer_cerulean_1', name: 'NADADORA DIANA', type: 'npc', position: { x: 4, y: 8 }, direction: 'down', trainerClass: 'swimmer', dialogue: ["¡El agua es mi elemento!", "¡Mis POKÉMON nadan más rápido que tú!"], isTrainer: true, trainerTeam: [makePokemon('goldeen', 'GOLDEEN', 16, 'water', [MOVES.TACKLE, MOVES.WATER_GUN], 111, { types: ['water'] })] },
      { id: 'jr_trainer_cerulean', name: 'CHICO LUIS', type: 'npc', position: { x: 6, y: 5 }, direction: 'left', trainerClass: 'jr_trainer', dialogue: ["¡Mis POKÉMON son fuertes!", "¡No me subestimes!"], isTrainer: true, trainerTeam: [makePokemon('horsea', 'HORSEA', 17, 'water', [MOVES.TACKLE, MOVES.WATER_GUN], 59, { types: ['water'] })] },
      { id: 'misty', name: 'MISTY', type: 'npc', position: { x: 4, y: 2 }, direction: 'down', trainerClass: 'misty', dialogue: badges.includes('CASCADE') ? ["¡Sigues mejorando como entrenador!", "¡Los POKÉMON de agua son los mejores!"] : ["¡Soy MISTY, la líder del GIMNASIO!", "¡Mi especialidad son los POKÉMON de tipo AGUA!", "¡Prepárate para mojarte!"], isTrainer: true, trainerTeam: [makePokemon('staryu', 'STARYU', 18, 'water', [MOVES.TACKLE, MOVES.WATER_GUN, MOVES.HARDEN], 106, { types: ['water'] }), makePokemon('starmie', 'STARMIE', 21, 'water', [MOVES.TACKLE, MOVES.WATER_GUN, MOVES.HARDEN], 207, { types: ['water', 'psychic'] })] }
    ],
    VERMILION_GYM: [
      { id: 'rocker_vermilion_1', name: 'ROCKERO HORACIO', type: 'npc', position: { x: 4, y: 8 }, direction: 'down', trainerClass: 'rocker', dialogue: ["¡La electricidad mueve el rock!", "¡Te voy a sacudir!"], isTrainer: true, trainerTeam: [makePokemon('voltorb', 'VOLTORB', 20, 'electric', [MOVES.TACKLE, MOVES.THUNDERSHOCK], 103)] },
      { id: 'gentleman_vermilion', name: 'CABALLERO RAUL', type: 'npc', position: { x: 6, y: 5 }, direction: 'left', trainerClass: 'gentleman', dialogue: ["¡Mis POKÉMON tienen chispa!", "¡Siente el trueno!"], isTrainer: true, trainerTeam: [makePokemon('pikachu', 'PIKACHU', 21, 'electric', [MOVES.THUNDERSHOCK, MOVES.GROWL], 82)] },
      { id: 'surge', name: 'TTE. SURGE', type: 'npc', position: { x: 4, y: 2 }, direction: 'down', trainerClass: 'surge', dialogue: badges.includes('THUNDER') ? ["¡Tienes potencial, novato!", "¡Sigue entrenando con esa MEDALLA TRUENO!"] : ["¡EH! ¡Soy el TENIENTE SURGE!", "¡Mis POKÉMON eléctricos te van a electrocutar!", "¡Prepárate para el dolor!"], isTrainer: true, trainerTeam: [makePokemon('voltorb', 'VOLTORB', 21, 'electric', [MOVES.TACKLE, MOVES.THUNDERSHOCK], 103), makePokemon('pikachu', 'PIKACHU', 18, 'electric', [MOVES.THUNDERSHOCK, MOVES.GROWL], 82), makePokemon('raichu', 'RAICHU', 24, 'electric', [MOVES.THUNDERSHOCK, MOVES.GROWL], 122)] }
    ],
    ROCK_TUNNEL_1F: [],
    POKEMON_TOWER_1F: [],
  };
