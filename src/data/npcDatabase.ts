...
export function buildNPCDatabase(
  ...
  const manual = {
    ...
    KANTO_OVERWORLD: [
      ...
      { id: 'hiker_route_10_6', name: 'MONTAÑERO', type: 'npc', position: w('ROUTE_10', 3, 57), direction: 'up', trainerClass: 'hiker', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('geodude', 'GEODUDE', 21, 'rock', [MOVES.ROCK_THROW, MOVES.DIG], 74, { types: ['rock', 'ground'] }), makePokemon('onix', 'ONIX', 21, 'rock', [MOVES.ROCK_THROW, MOVES.DIG], 95, { types: ['rock', 'ground'] })] },
      ...
      { id: 'gambler_route_11_0', name: 'GOLFO', type: 'npc', position: w('ROUTE_11', 10, 14), direction: 'down', trainerClass: 'gambler', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('poliwag', 'POLIWAG', 18, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 60), makePokemon('horsea', 'HORSEA', 18, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 116)] },
      ...
      { id: 'fisher_route_12_3', name: 'PESCADOR', type: 'npc', position: w('ROUTE_12', 5, 39), direction: 'up', trainerClass: 'fisher', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('tentacool', 'TENTACOOL', 24, 'water', [MOVES.WATER_GUN, MOVES.POISON_POWDER], 72, { types: ['water', 'poison'] }), makePokemon('goldeen', 'GOLDEEN', 24, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 118)] },
      ...
      { id: 'fisher_route_12_4', name: 'PESCADOR', type: 'npc', position: w('ROUTE_12', 12, 40), direction: 'left', trainerClass: 'fisher', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('goldeen', 'GOLDEEN', 27, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 118)] },
      { id: 'fisher_route_12_5', name: 'PESCADOR', type: 'npc', position: w('ROUTE_12', 9, 52), direction: 'right', trainerClass: 'fisher', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('poliwag', 'POLIWAG', 21, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 60), makePokemon('shellder', 'SHELLDER', 21, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 90), makePokemon('goldeen', 'GOLDEEN', 21, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 118), makePokemon('horsea', 'HORSEA', 21, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 116)] },
      { id: 'fisher_route_12_10', name: 'PESCADOR', type: 'npc', position: w('ROUTE_12', 6, 87), direction: 'down', trainerClass: 'fisher', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('magikarp', 'MAGIKARP', 24, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 129), makePokemon('magikarp', 'MAGIKARP', 24, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 129)] },
      { id: 'birdkeeper_route_13_0', name: 'ORNITÓLOGO', type: 'npc', position: w('ROUTE_13', 49, 10), direction: 'right', trainerClass: 'birdkeeper', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('pidgey', 'PIDGEY', 29, 'normal', [MOVES.TACKLE, MOVES.GUST], 16, { types: ['normal', 'flying'] }), makePokemon('pidgeotto', 'PIDGEOTTO', 29, 'normal', [MOVES.TACKLE, MOVES.GUST], 17, { types: ['normal', 'flying'] })] },
      { id: 'jrtrainerf_route_13_11', name: 'ENTRENADORA', type: 'npc', position: w('ROUTE_13', 48, 10), direction: 'down', trainerClass: 'cooltrainer_f', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('pidgey', 'PIDGEY', 24, 'normal', [MOVES.TACKLE, MOVES.GUST], 16, { types: ['normal', 'flying'] }), makePokemon('meowth', 'MEOWTH', 24, 'normal', [MOVES.TACKLE, MOVES.TACKLE], 52), makePokemon('rattata', 'RATTATA', 24, 'normal', [MOVES.TACKLE, MOVES.TACKLE], 19), makePokemon('pikachu', 'PIKACHU', 24, 'electric', [MOVES.THUNDERSHOCK, MOVES.TACKLE], 25), makePokemon('meowth', 'MEOWTH', 24, 'normal', [MOVES.TACKLE, MOVES.TACKLE], 52)] },
      ...
      { id: 'jrtrainerf_route_13_13', name: 'ENTRENADORA', type: 'npc', position: w('ROUTE_13', 23, 10), direction: 'left', trainerClass: 'cooltrainer_f', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('pidgey', 'PIDGEY', 27, 'normal', [MOVES.TACKLE, MOVES.GUST], 16, { types: ['normal', 'flying'] }), makePokemon('meowth', 'MEOWTH', 27, 'normal', [MOVES.TACKLE, MOVES.TACKLE], 52), makePokemon('pidgey', 'PIDGEY', 27, 'normal', [MOVES.TACKLE, MOVES.GUST], 16, { types: ['normal', 'flying'] }), makePokemon('pidgeotto', 'PIDGEOTTO', 27, 'normal', [MOVES.TACKLE, MOVES.GUST], 17, { types: ['normal', 'flying'] })] },
      ...
      { id: 'birdkeeper_route_14_13', name: 'ORNITÓLOGO', type: 'npc', position: w('ROUTE_14', 4, 4), direction: 'down', trainerClass: 'birdkeeper', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('pidgey', 'PIDGEY', 28, 'normal', [MOVES.TACKLE, MOVES.GUST], 16, { types: ['normal', 'flying'] }), makePokemon('doduo', 'DODUO', 28, 'normal', [MOVES.TACKLE, MOVES.GUST], 84, { types: ['normal', 'flying'] }), makePokemon('pidgeotto', 'PIDGEOTTO', 28, 'normal', [MOVES.TACKLE, MOVES.GUST], 17, { types: ['normal', 'flying'] })] },
      { id: 'birdkeeper_route_14_14', name: 'ORNITÓLOGO', type: 'npc', position: w('ROUTE_14', 15, 6), direction: 'down', trainerClass: 'birdkeeper', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('pidgey', 'PIDGEY', 26, 'normal', [MOVES.TACKLE, MOVES.GUST], 16, { types: ['normal', 'flying'] }), makePokemon('spearow', 'SPEAROW', 26, 'normal', [MOVES.TACKLE, MOVES.GUST], 21, { types: ['normal', 'flying'] }), makePokemon('pidgey', 'PIDGEY', 26, 'normal', [MOVES.TACKLE, MOVES.GUST], 16, { types: ['normal', 'flying'] }), makePokemon('fearow', 'FEAROW', 26, 'normal', [MOVES.TACKLE, MOVES.GUST], 22, { types: ['normal', 'flying'] })] },
      ...
      { id: 'biker_route_14_1', name: 'MOTORISTA', type: 'npc', position: w('ROUTE_14', 4, 31), direction: 'right', trainerClass: 'biker', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('koffing', 'KOFFING', 29, 'poison', [MOVES.POISON_POWDER, MOVES.TACKLE], 109), makePokemon('grimer', 'GRIMER', 29, 'poison', [MOVES.POISON_POWDER, MOVES.TACKLE], 88)] },
      { id: 'jrtrainerf_route_15_19', name: 'ENTRENADORA', type: 'npc', position: w('ROUTE_15', 41, 11), direction: 'down', trainerClass: 'cooltrainer_f', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('gloom', 'GLOOM', 28, 'grass', [MOVES.VINE_WHIP, MOVES.POISON_POWDER], 44, { types: ['grass', 'poison'] }), makePokemon('oddish', 'ODDISH', 28, 'grass', [MOVES.VINE_WHIP, MOVES.POISON_POWDER], 43, { types: ['grass', 'poison'] }), makePokemon('oddish', 'ODDISH', 28, 'grass', [MOVES.VINE_WHIP, MOVES.POISON_POWDER], 43, { types: ['grass', 'poison'] })] },
      ...
      { id: 'cueball_route_16_2', name: 'GOLFO', type: 'npc', position: w('ROUTE_16', 6, 10), direction: 'right', trainerClass: 'gambler', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('machop', 'MACHOP', 33, 'fighting', [MOVES.DOUBLE_KICK, MOVES.TACKLE], 66)] },
      ...
      { id: 'swimmer_route_19_1', name: 'NADADOR', type: 'npc', position: w('ROUTE_19', 8, 7), direction: 'left', trainerClass: 'swimmer', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('tentacool', 'TENTACOOL', 30, 'water', [MOVES.WATER_GUN, MOVES.POISON_POWDER], 72, { types: ['water', 'poison'] }), makePokemon('shellder', 'SHELLDER', 30, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 90)] },
      { id: 'swimmer_route_19_2', name: 'NADADOR', type: 'npc', position: w('ROUTE_19', 13, 7), direction: 'left', trainerClass: 'swimmer', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('goldeen', 'GOLDEEN', 29, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 118), makePokemon('horsea', 'HORSEA', 29, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 116), makePokemon('staryu', 'STARYU', 29, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 120)] },
      ...
      { id: 'beauty_route_20_14', name: 'BELLEZA', type: 'npc', position: w('ROUTE_20', 68, 11), direction: 'up', trainerClass: 'beauty', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('seadra', 'SEADRA', 30, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 117), makePokemon('horsea', 'HORSEA', 30, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 116), makePokemon('seadra', 'SEADRA', 30, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 117)] },
      { id: 'beauty_route_20_5', name: 'BELLEZA', type: 'npc', position: w('ROUTE_20', 45, 10), direction: 'down', trainerClass: 'beauty', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('seaking', 'SEAKING', 35, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 119)] },
      { id: 'jrtrainerf_route_20_23', name: 'ENTRENADORA', type: 'npc', position: w('ROUTE_20', 55, 14), direction: 'right', trainerClass: 'cooltrainer_f', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('tentacool', 'TENTACOOL', 30, 'water', [MOVES.WATER_GUN, MOVES.POISON_POWDER], 72, { types: ['water', 'poison'] }), makePokemon('horsea', 'HORSEA', 30, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 116), makePokemon('seel', 'SEEL', 30, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 86)] },
      { id: 'swimmer_route_20_9', name: 'NADADOR', type: 'npc', position: w('ROUTE_20', 38, 13), direction: 'down', trainerClass: 'swimmer', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('staryu', 'STARYU', 35, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 120)] },
      { id: 'swimmer_route_20_10', name: 'NADADOR', type: 'npc', position: w('ROUTE_20', 87, 13), direction: 'up', trainerClass: 'swimmer', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('horsea', 'HORSEA', 28, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 116), makePokemon('horsea', 'HORSEA', 28, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 116), makePokemon('seadra', 'SEADRA', 28, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 117), makePokemon('horsea', 'HORSEA', 28, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 116)] },
      { id: 'birdkeeper_route_20_10', name: 'ORNITÓLOGO', type: 'npc', position: w('ROUTE_20', 34, 9), direction: 'up', trainerClass: 'birdkeeper', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('fearow', 'FEAROW', 30, 'normal', [MOVES.TACKLE, MOVES.GUST], 22, { types: ['normal', 'flying'] }), makePokemon('fearow', 'FEAROW', 30, 'normal', [MOVES.TACKLE, MOVES.GUST], 22, { types: ['normal', 'flying'] }), makePokemon('pidgeotto', 'PIDGEOTTO', 30, 'normal', [MOVES.TACKLE, MOVES.GUST], 17, { types: ['normal', 'flying'] })] },
      ...
      { id: 'jrtrainerf_route_20_15', name: 'ENTRENADORA', type: 'npc', position: w('ROUTE_20', 24, 12), direction: 'down', trainerClass: 'cooltrainer_f', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('goldeen', 'GOLDEEN', 31, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 118), makePokemon('seaking', 'SEAKING', 31, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 119)] },
      { id: 'beauty_route_20_7', name: 'BELLEZA', type: 'npc', position: w('ROUTE_20', 15, 8), direction: 'up', trainerClass: 'beauty', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('poliwag', 'POLIWAG', 31, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 60), makePokemon('seaking', 'SEAKING', 31, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 119)] },
      { id: 'fisher_route_21_6', name: 'PESCADOR', type: 'npc', position: w('ROUTE_21', 4, 24), direction: 'left', trainerClass: 'fisher', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('seaking', 'SEAKING', 28, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 119), makePokemon('goldeen', 'GOLDEEN', 28, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 118), makePokemon('seaking', 'SEAKING', 28, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 119), makePokemon('seaking', 'SEAKING', 28, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 119)] },
      { id: 'fisher_route_21_8', name: 'PESCADOR', type: 'npc', position: w('ROUTE_21', 6, 25), direction: 'down', trainerClass: 'fisher', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('magikarp', 'MAGIKARP', 27, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 129), makePokemon('magikarp', 'MAGIKARP', 27, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 129), makePokemon('magikarp', 'MAGIKARP', 27, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 129), makePokemon('magikarp', 'MAGIKARP', 27, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 129), makePokemon('magikarp', 'MAGIKARP', 27, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 129), makePokemon('magikarp', 'MAGIKARP', 27, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 129)] },
      { id: 'swimmer_route_21_11', name: 'NADADOR', type: 'npc', position: w('ROUTE_21', 10, 31), direction: 'up', trainerClass: 'swimmer', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('seadra', 'SEADRA', 33, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 117), makePokemon('tentacruel', 'TENTACRUEL', 33, 'water', [MOVES.WATER_GUN, MOVES.POISON_POWDER], 73, { types: ['water', 'poison'] })] },
      { id: 'cueball_route_21_8', name: 'GOLFO', type: 'npc', position: w('ROUTE_21', 12, 30), direction: 'right', trainerClass: 'gambler', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('tentacool', 'TENTACOOL', 31, 'water', [MOVES.WATER_GUN, MOVES.POISON_POWDER], 72, { types: ['water', 'poison'] }), makePokemon('tentacool', 'TENTACOOL', 31, 'water', [MOVES.WATER_GUN, MOVES.POISON_POWDER], 72, { types: ['water', 'poison'] }), makePokemon('tentacruel', 'TENTACRUEL', 31, 'water', [MOVES.WATER_GUN, MOVES.POISON_POWDER], 73, { types: ['water', 'poison'] })] },
      ...
      { id: 'youngster_route_25_5', name: 'JOVEN', type: 'npc', position: w('ROUTE_25', 18, 5), direction: 'up', trainerClass: 'youngster', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('slowpoke', 'SLOWPOKE', 17, 'water', [MOVES.WATER_GUN, MOVES.CONFUSION], 79, { types: ['water', 'psychic'] })] },
      ...
      { id: 'youngster_route_3_1', name: 'JOVEN', type: 'npc', position: w('ROUTE_3', 22, 9), direction: 'left', trainerClass: 'youngster', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('spearow', 'SPEAROW', 14, 'normal', [MOVES.TACKLE, MOVES.GUST], 21, { types: ['normal', 'flying'] })] },
      ...
      { id: 'hiker_route_9_10', name: 'MONTAÑERO', type: 'npc', position: w('ROUTE_9', 16, 15), direction: 'left', trainerClass: 'hiker', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('machop', 'MACHOP', 20, 'fighting', [MOVES.DOUBLE_KICK, MOVES.TACKLE], 66), makePokemon('onix', 'ONIX', 20, 'rock', [MOVES.ROCK_THROW, MOVES.DIG], 95, { types: ['rock', 'ground'] })] },
      { id: 'bugcatcher_viridian_forest_0', name: 'CAZABICHOS', type: 'npc', position: w('VIRIDIAN_FOREST', 30, 33), direction: 'left', trainerClass: 'bugcatcher', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('weedle', 'WEEDLE', 6, 'bug', [MOVES.STRING_SHOT, MOVES.POISON_POWDER], 13, { types: ['bug', 'poison'] }), makePokemon('caterpie', 'CATERPIE', 6, 'bug', [MOVES.STRING_SHOT, MOVES.TACKLE], 10)] },
      { id: 'bugcatcher_viridian_forest_1', name: 'CAZABICHOS', type: 'npc', position: w('VIRIDIAN_FOREST', 30, 19), direction: 'left', trainerClass: 'bugcatcher', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('weedle', 'WEEDLE', 7, 'bug', [MOVES.STRING_SHOT, MOVES.POISON_POWDER], 13, { types: ['bug', 'poison'] }), makePokemon('kakuna', 'KAKUNA', 7, 'bug', [MOVES.STRING_SHOT, MOVES.POISON_POWDER], 14, { types: ['bug', 'poison'] }), makePokemon('weedle', 'WEEDLE', 7, 'bug', [MOVES.STRING_SHOT, MOVES.POISON_POWDER], 13, { types: ['bug', 'poison'] })] },
      { id: 'bugcatcher_viridian_forest_2', name: 'CAZABICHOS', type: 'npc', position: w('VIRIDIAN_FOREST', 2, 18), direction: 'left', trainerClass: 'bugcatcher', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('weedle', 'WEEDLE', 9, 'bug', [MOVES.STRING_SHOT, MOVES.POISON_POWDER], 13, { types: ['bug', 'poison'] })] },
      ...
      ...(!badges.includes('CASCADE') ? [{ id: 'guard_route23_2', name: 'GUARDIA', type: 'npc' as const, position: w('ROUTE_23', 6, 14), direction: 'down' as Direction, trainerClass: 'citizen', questId: 'badge_check' as const, requiredBadge: 'CASCADE', dialogue: ['¡Alto! Necesitas la MEDALLA CASCADA para seguir.', '¡Debes vencer a MISTY en CIUDAD CELESTE!'] }] : []),
      ...(!badges.includes('THUNDER') ? [{ id: 'guard_route23_3', name: 'GUARDIA', type: 'npc' as const, position: w('ROUTE_23', 6, 20), direction: 'down' as Direction, trainerClass: 'citizen', questId: 'badge_check' as const, requiredBadge: 'THUNDER', dialogue: ['¡Alto! Necesitas la MEDALLA TRUENO para seguir.', '¡Debes vencer a LT. SURGE en CIUDAD CARMÍN!'] }] : []),
      ...(!badges.includes('RAINBOW') ? [{ id: 'guard_route23_4', name: 'GUARDIA', type: 'npc' as const, position: w('ROUTE_23', 6, 26), direction: 'down' as Direction, trainerClass: 'citizen', questId: 'badge_check' as const, requiredBadge: 'RAINBOW', dialogue: ['¡Alto! Necesitas la MEDALLA ARCOIRIS para seguir.', '¡Debes vencer a ERIKA en CIUDAD AZULONA!'] }] : []),
      ...
      ...(playerTeam.length === 0 ? [{ id: 'guard_route22_gate', name: 'GUARDIA', type: 'npc' as const, position: w('ROUTE_22', 11, 2), direction: 'down' as Direction, trainerClass: 'citizen', questId: 'route22_check' as const, dialogue: ['¡Alto! La RUTA 22 es muy peligrosa.', '¡No puedes ir sin POKÉMON!'] }] : []),
    ],
    ...
    CERULEAN_GYM: [
      { id: 'swimmer_cerulean_gym', name: 'NADADOR LUIS', type: 'npc', position: { x: 2, y: 3 }, direction: 'left', trainerClass: 'swimmer', dialogue: ['¡No permito que cualquiera vea a MISTY!', '¡Solo los mejores pueden desafiarla!'], isTrainer: true, trainerTeam: [makePokemon('horsea', 'HORSEA', 16, 'water', [MOVES.WATER_GUN], 116, { types: ['water'] }), makePokemon('shellder', 'SHELLDER', 16, 'water', [MOVES.TACKLE, MOVES.WATER_GUN], 90, { types: ['water'] })] },
      { id: 'misty', name: 'MISTY', type: 'npc', position: { x: 4, y: 2 }, direction: 'down', trainerClass: 'misty', dialogue: ['¡Soy MISTY!', '¡La líder del gimnasio de CIUDAD CELESTE!', '¡Mis POKÉMON de agua son invencibles!'], isTrainer: true, trainerTeam: [makePokemon('staryu', 'STARYU', 18, 'water', [MOVES.TACKLE, MOVES.WATER_GUN], 120, { types: ['water'] }), makePokemon('starmie', 'STARMIE', 21, 'water', [MOVES.TACKLE, MOVES.WATER_GUN, MOVES.BUBBLEBEAM], 121, { types: ['water', 'psychic'] })] },
    ...
    FUCHSIA_GYM: [
      { id: 'juggler_fuchsia_gym', name: 'MALABARISTA KAY', type: 'npc', position: { x: 1, y: 12 }, direction: 'left', trainerClass: 'juggler', dialogue: ['¡KOGA es un maestro ninja!', '¡No llegarás a verlo!'], isTrainer: true, trainerTeam: [makePokemon('koffing', 'KOFFING', 30, 'poison', [MOVES.TACKLE, MOVES.POISON_POWDER], 109, { types: ['poison'] })] },
      { id: 'koga', name: 'KOGA', type: 'npc', position: { x: 8, y: 2 }, direction: 'down', trainerClass: 'koga', dialogue: ['¡Soy KOGA!', '¡Líder del gimnasio de CIUDAD FUCSIA!', '¡Mis tácticas ninja y POKÉMON veneno te derrotarán!'], isTrainer: true, trainerTeam: [makePokemon('koffing', 'KOFFING', 37, 'poison', [MOVES.TACKLE, MOVES.POISON_POWDER], 109, { types: ['poison'] }), makePokemon('muk', 'MUK', 39, 'poison', [MOVES.POUND, MOVES.POISON_POWDER], 89, { types: ['poison'] }), makePokemon('koffing', 'KOFFING', 37, 'poison', [MOVES.TACKLE, MOVES.POISON_POWDER], 109, { types: ['poison'] }), makePokemon('weezing', 'WEEZING', 43, 'poison', [MOVES.TACKLE, MOVES.POISON_POWDER, MOVES.TACKLE], 110, { types: ['poison'] })] },
    
      { id: 'koga_fuchsia_gym_0', name: 'KOGA', type: 'npc', position: { x: 3, y: 5 }, direction: 'down', trainerClass: 'koga', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('koffing', 'KOFFING', 37, 'poison', [MOVES.POISON_POWDER, MOVES.TACKLE], 109), makePokemon('muk', 'MUK', 39, 'poison', [MOVES.POISON_POWDER, MOVES.TACKLE], 89), makePokemon('koffing', 'KOFFING', 37, 'poison', [MOVES.POISON_POWDER, MOVES.TACKLE], 109), makePokemon('weezing', 'WEEZING', 43, 'poison', [MOVES.POISON_POWDER, MOVES.TACKLE], 110)] },
      { id: 'juggler_fuchsia_gym_2', name: 'MALABARISTA', type: 'npc', position: { x: 8, y: 13 }, direction: 'down', trainerClass: 'juggler', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('drowzee', 'DROWZEE', 31, 'psychic', [MOVES.CONFUSION, MOVES.TACKLE], 96), makePokemon('drowzee', 'DROWZEE', 31, 'psychic', [MOVES.CONFUSION, MOVES.TACKLE], 96), makePokemon('kadabra', 'KADABRA', 31, 'psychic', [MOVES.CONFUSION, MOVES.TACKLE], 64), makePokemon('drowzee', 'DROWZEE', 31, 'psychic', [MOVES.CONFUSION, MOVES.TACKLE], 96)] },
    ...
    SAFFRON_GYM: [
      { id: 'sabrina', name: 'SABRINA', type: 'npc', position: { x: 3, y: 13 }, direction: 'down', trainerClass: 'sabrina', dialogue: ['...Soy SABRINA...', 'Líder del gimnasio de CIUDAD AZAFRÁN.', '...Tu mente es débil...'], isTrainer: true, trainerTeam: [makePokemon('kadabra', 'KADABRA', 38, 'psychic', [MOVES.POUND, MOVES.TACKLE], 64, { types: ['psychic'] }), makePokemon('venomoth', 'VENOMOTH', 38, 'bug', [MOVES.TACKLE, MOVES.POISON_POWDER], 49, { types: ['bug', 'poison'] }), makePokemon('alakazam', 'ALAKAZAM', 43, 'psychic', [MOVES.POUND, MOVES.TACKLE], 65, { types: ['psychic'] })] },
...
export function buildItemDatabase(pickedItemIds: string[], storyStep: string): Record<MapID, Entity[]> {
  ...
  const rawItems = {
    KANTO_OVERWORLD: [
      ...
      { id: 'sign_center_fuchsia', type: 'object', position: w('FUCHSIA_CITY', 20, 25), direction: 'down', sprite: '🪧', dialogue: ['CENTRO POKÉMON'] },
      { id: 'sign_warden_fuchsia', type: 'object', position: w('FUCHSIA_CITY', 29, 29), direction: 'down', sprite: '🪧', dialogue: ['CASA DEL GUARDA DE LA ZONA SAFARI'] },
      ...
      { id: 'sign_center_celadon', type: 'object', position: w('CELADON_CITY', 42, 7), direction: 'down', sprite: '🪧', dialogue: ['CENTRO POKÉMON'] },
      ...
      { id: 'sign_mansion_celadon', type: 'object', position: w('CELADON_CITY', 21, 12), direction: 'down', sprite: '🪧', dialogue: ['MANSIÓN AZULONA'] },
      { id: 'door_celadon_mansion', type: 'object', position: w('CELADON_CITY', 21, 8), direction: 'up', sprite: '🚪', dialogue: ['Está cerrado.'] },
      { id: 'sign_deptstore_celadon', type: 'object', position: w('CELADON_CITY', 12, 15), direction: 'down', sprite: '🪧', dialogue: ['CENTRO COMERCIAL DE AZULONA'] },
      ...
      { id: 'sign_mrpsychic_saffron', type: 'object', position: w('SAFFRON_CITY', 27, 32), direction: 'down', sprite: '🪧', dialogue: ['CASA DEL SR. PSÍQUICO'] },
      ...
      { id: 'sign_center_cerulean', type: 'object', position: w('CERULEAN_CITY', 20, 15), direction: 'down', sprite: '🪧', dialogue: ['CENTRO POKÉMON'] },
      ...
      { id: 'sign_center_vermilion', type: 'object', position: w('VERMILION_CITY', 12, 7), direction: 'down', sprite: '🪧', dialogue: ['CENTRO POKÉMON'] },
      { id: 'sign_fanclub_vermilion', type: 'object', position: w('VERMILION_CITY', 8, 15), direction: 'down', sprite: '🪧', dialogue: ['CLUB DE FANS DE POKÉMON', '¡Todos son bienvenidos!'] },
