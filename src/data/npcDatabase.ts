...
export function buildNPCDatabase(
  ...
  const manual = {
    ...
    KANTO_OVERWORLD: [
      ...
      { id: 'cerulean_cooltrainer_m', name: 'ENTRENADOR', type: 'npc', position: w('CERULEAN_CITY', 31, 21), direction: 'down', trainerClass: 'cooltrainer_m', dialogue: ["¡MISTY es la mejor!", "¡Sus POKÉMON de agua son invencibles!"] },
      ...
      { id: 'vermilion_gambler1', name: 'GOLFO', type: 'npc', position: w('VERMILION_CITY', 15, 6), direction: 'down', trainerClass: 'gambler', dialogue: ["¡El S.S. ANNE está en el puerto!", "¡Dicen que hay muchos entrenadores a bordo!"] },
