...
export function buildNPCDatabase(
  ...
  return {
    ...
    KANTO_OVERWORLD: [
      ...
      // ── Route 3 ──
      { id: 'bug_catcher_rt3', name: 'CAZABICHOS RICK', type: 'npc', position: w('ROUTE_3', 10, 6), direction: 'right' as Direction, trainerClass: 'bugcatcher', dialogue: ["¡Los bichos son los mejores POKÉMON!", "¡Te voy a demostrar que soy el mejor!"], isTrainer: true, trainerTeam: [makePokemon('weedle', 'WEEDLE', 10, 'bug', [MOVES.TACKLE, MOVES.STRING_SHOT], 13, { types: ['bug', 'poison'] }), makePokemon('caterpie', 'CATERPIE', 10, 'bug', [MOVES.TACKLE, MOVES.STRING_SHOT], 10)] },
      { id: 'lass_rt3', name: 'CHICA JANICE', type: 'npc', position: w('ROUTE_3', 16, 9), direction: 'left' as Direction, trainerClass: 'lass', dialogue: ["¡Oye tú! ¡No pases por aquí sin luchar!", "¡Mis PIDGEY son adorables Y fuertes!"], isTrainer: true, trainerTeam: [makePokemon('pidgey', 'PIDGEY', 11, 'flying', [MOVES.TACKLE, MOVES.GUST], 16, { types: ['normal', 'flying'] }), makePokemon('pidgey', 'PIDGEY', 11, 'flying', [MOVES.TACKLE, MOVES.GUST], 16, { types: ['normal', 'flying'] })] },
      { id: 'youngster_rt3', name: 'CHICO BEN', type: 'npc', position: w('ROUTE_3', 14, 4), direction: 'down' as Direction, trainerClass: 'youngster', dialogue: ["¡Llevo mis pantalones cortos todo el año!", "¡Eso me hace más fuerte!"], isTrainer: true, trainerTeam: [makePokemon('rattata', 'RATTATA', 10, 'normal', [MOVES.TACKLE, MOVES.SCRATCH], 19), makePokemon('ekans', 'EKANS', 10, 'poison', [MOVES.TACKLE, MOVES.GROWL], 23, { types: ['poison'] })] },
      { id: 'lass_rt3_2', name: 'CHICA HALEY', type: 'npc', position: w('ROUTE_3', 19, 5), direction: 'down' as Direction, trainerClass: 'lass', dialogue: ["¡Las flores son mis favoritas!", "¡Prepárate!"], isTrainer: true, trainerTeam: [makePokemon('oddish', 'ODDISH', 14, 'grass', [MOVES.POUND, MOVES.SLEEP_POWDER], 43, { types: ['grass', 'poison'] })] },
      // ── Route 4 ──
      { id: 'lass_rt4', name: 'CHICA CRINA', type: 'npc', position: w('ROUTE_4', 63, 3), direction: 'down', trainerClass: 'lass', dialogue: ['¡Tengo una POKÉDEX genial!'], isTrainer: true, trainerTeam: [makePokemon('paras', 'PARAS', 31, 'bug', [MOVES.SCRATCH, MOVES.STRING_SHOT], 46, { types: ['bug', 'grass'] }), makePokemon('paras', 'PARAS', 31, 'bug', [MOVES.SCRATCH, MOVES.STRING_SHOT], 46, { types: ['bug', 'grass'] }), makePokemon('parasect', 'PARASECT', 31, 'bug', [MOVES.SCRATCH, MOVES.STRING_SHOT], 47, { types: ['bug', 'grass'] })] },
      // ── Route 6 ──
      { id: 'cooltrainer_m_rt6', name: 'ENTRENADOR LIONEL', type: 'npc', position: w('ROUTE_6', 10, 21), direction: 'right', trainerClass: 'cooltrainer_m', dialogue: ['¡A ver quién es mejor!'], isTrainer: true, trainerTeam: [makePokemon('squirtle', 'SQUIRTLE', 20, 'water', [MOVES.TACKLE, MOVES.WATER_GUN], 7, { types: ['water'] })] },
      { id: 'youngster_rt6', name: 'CHICO RICKY', type: 'npc', position: w('ROUTE_6', 0, 15), direction: 'right', trainerClass: 'youngster', dialogue: ['¡Estoy investigando los bichos!'], isTrainer: true, trainerTeam: [makePokemon('weedle', 'WEEDLE', 16, 'bug', [MOVES.TACKLE, MOVES.STRING_SHOT], 13, { types: ['bug', 'poison'] }), makePokemon('caterpie', 'CATERPIE', 16, 'bug', [MOVES.TACKLE, MOVES.STRING_SHOT], 10), makePokemon('weedle', 'WEEDLE', 16, 'bug', [MOVES.TACKLE, MOVES.STRING_SHOT], 13, { types: ['bug', 'poison'] })] },
      // ── Route 8 ──
      { id: 'cooltrainer_f_rt8', name: 'ENTRENADORA LOLA', type: 'npc', position: w('ROUTE_8', 13, 9), direction: 'down', trainerClass: 'cooltrainer_f', dialogue: ['¡Tengo los mejores POKÉMON!'], isTrainer: true, trainerTeam: [makePokemon('meowth', 'MEOWTH', 24, 'normal', [MOVES.SCRATCH, MOVES.GROWL], 52), makePokemon('meowth', 'MEOWTH', 24, 'normal', [MOVES.SCRATCH, MOVES.GROWL], 52), makePokemon('meowth', 'MEOWTH', 24, 'normal', [MOVES.SCRATCH, MOVES.GROWL], 52)] },
      { id: 'cooltrainer_f_rt8_2', name: 'ENTRENADORA MIA', type: 'npc', position: w('ROUTE_8', 26, 6), direction: 'down', trainerClass: 'cooltrainer_f', dialogue: ['¡Mis POKÉMON son irresistibles!'], isTrainer: true, trainerTeam: [makePokemon('clefairy', 'CLEFAIRY', 22, 'normal', [MOVES.POUND, MOVES.GROWL], 35), makePokemon('clefairy', 'CLEFAIRY', 22, 'normal', [MOVES.POUND, MOVES.GROWL], 35)] },
      // ── Route 10 ──
      { id: 'cooltrainer_f_rt10', name: 'ENTRENADORA CAROL', type: 'npc', position: w('ROUTE_10', 7, 25), direction: 'down', trainerClass: 'cooltrainer_f', dialogue: ['¡Soy fuerte y hermosa!', '¡Una combinación mortal!'], isTrainer: true, trainerTeam: [makePokemon('pikachu', 'PIKACHU', 20, 'electric', [MOVES.THUNDERSHOCK, MOVES.TACKLE], 25, { types: ['electric'] }), makePokemon('clefairy', 'CLEFAIRY', 20, 'normal', [MOVES.POUND, MOVES.GROWL], 35)] },
      { id: 'cooltrainer_f_rt10_2', name: 'ENTRENADORA SANDRA', type: 'npc', position: w('ROUTE_10', 10, 44), direction: 'down', trainerClass: 'cooltrainer_f', dialogue: ['¡Mis pájaros te vencerán!'], isTrainer: true, trainerTeam: [makePokemon('pidgey', 'PIDGEY', 21, 'flying', [MOVES.TACKLE, MOVES.GUST], 16, { types: ['normal', 'flying'] }), makePokemon('pidgeotto', 'PIDGEOTTO', 21, 'flying', [MOVES.TACKLE, MOVES.GUST], 17, { types: ['normal', 'flying'] })] },
      // ── Route 11 ──
      { id: 'gambler_rt11', name: 'GOLFO YASU', type: 'npc', position: w('ROUTE_11', 13, 5), direction: 'down', trainerClass: 'gambler', dialogue: ['¡La vida es un juego!', '¡Y yo siempre gano!'], isTrainer: true, trainerTeam: [makePokemon('growlithe', 'GROWLITHE', 18, 'fire', [MOVES.EMBER, MOVES.TACKLE], 58, { types: ['fire'] }), makePokemon('vulpix', 'VULPIX', 18, 'fire', [MOVES.EMBER, MOVES.TACKLE], 37, { types: ['fire'] })] },
      // ── Route 12 / 16 Snorlax ──
      ...
      { id: 'pokemaniac_kanto_overworld_0', name: 'POKÉMANÍACO', type: 'npc', position: w('ROUTE_10', 7, 54), direction: 'down', trainerClass: 'pokemaniac', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('rhyhorn', 'RHYHORN', 30, 'ground', [MOVES.DIG, MOVES.ROCK_THROW], 111, { types: ['ground', 'rock'] }), makePokemon('lickitung', 'LICKITUNG', 30, 'normal', [MOVES.TACKLE, MOVES.TACKLE], 108)] },
      ...
      { id: 'jrtrainerf_kanto_overworld_6', name: 'ENTRENADORA', type: 'npc', position: w('ROUTE_10', 3, 61), direction: 'down', trainerClass: 'cooltrainer_f', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('pikachu', 'PIKACHU', 20, 'electric', [MOVES.THUNDERSHOCK, MOVES.TACKLE], 25), makePokemon('clefairy', 'CLEFAIRY', 20, 'normal', [MOVES.TACKLE, MOVES.TACKLE], 35)] },
      { id: 'hiker_kanto_overworld_7', name: 'MONTAÑERO', type: 'npc', position: w('ROUTE_10', 14, 64), direction: 'down', trainerClass: 'hiker', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('onix', 'ONIX', 19, 'rock', [MOVES.ROCK_THROW, MOVES.DIG], 95, { types: ['rock', 'ground'] }), makePokemon('graveler', 'GRAVELER', 19, 'rock', [MOVES.ROCK_THROW, MOVES.DIG], 75, { types: ['rock', 'ground'] })] },
      ...
      { id: 'youngster_kanto_overworld_8', name: 'JOVEN', type: 'npc', position: w('ROUTE_11', 22, 4), direction: 'down', trainerClass: 'youngster', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('ekans', 'EKANS', 21, 'poison', [MOVES.POISON_POWDER, MOVES.TACKLE], 23)] },
      ...
      { id: 'youngster_kanto_overworld_9', name: 'JOVEN', type: 'npc', position: w('ROUTE_11', 22, 12), direction: 'down', trainerClass: 'youngster', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('sandshrew', 'SANDSHREW', 19, 'ground', [MOVES.DIG, MOVES.TACKLE], 27), makePokemon('zubat', 'ZUBAT', 19, 'poison', [MOVES.POISON_POWDER, MOVES.GUST], 41, { types: ['poison', 'flying'] })] },
      ...
      { id: 'jrtrainerm_kanto_overworld_3', name: 'ENTRENADOR', type: 'npc', position: w('ROUTE_6', 11, 21), direction: 'down', trainerClass: 'cooltrainer_m', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('squirtle', 'SQUIRTLE', 20, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 7)] },
      { id: 'jrtrainerf_kanto_overworld_1', name: 'ENTRENADORA', type: 'npc', position: w('ROUTE_6', 11, 30), direction: 'down', trainerClass: 'cooltrainer_f', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('rattata', 'RATTATA', 16, 'normal', [MOVES.TACKLE, MOVES.TACKLE], 19), makePokemon('pikachu', 'PIKACHU', 16, 'electric', [MOVES.THUNDERSHOCK, MOVES.TACKLE], 25)] },
      ...
      { id: 'jrtrainerf_kanto_overworld_2', name: 'ENTRENADORA', type: 'npc', position: w('ROUTE_6', 19, 26), direction: 'down', trainerClass: 'cooltrainer_f', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('pidgey', 'PIDGEY', 16, 'normal', [MOVES.TACKLE, MOVES.GUST], 16, { types: ['normal', 'flying'] }), makePokemon('pidgey', 'PIDGEY', 16, 'normal', [MOVES.TACKLE, MOVES.GUST], 16, { types: ['normal', 'flying'] }), makePokemon('pidgey', 'PIDGEY', 16, 'normal', [MOVES.TACKLE, MOVES.GUST], 16, { types: ['normal', 'flying'] })] },
      ...
      { id: 'gambler_kanto_overworld_4', name: 'GOLFO', type: 'npc', position: w('ROUTE_8', 26, 5), direction: 'down', trainerClass: 'gambler', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('poliwag', 'POLIWAG', 22, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 60), makePokemon('poliwag', 'POLIWAG', 22, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 60), makePokemon('poliwhirl', 'POLIWHIRL', 22, 'water', [MOVES.WATER_GUN, MOVES.TACKLE], 61)] },
      ...
      { id: 'lass_kanto_overworld_13', name: 'CHICA', type: 'npc', position: w('ROUTE_8', 42, 6), direction: 'down', trainerClass: 'lass', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('meowth', 'MEOWTH', 24, 'normal', [MOVES.TACKLE, MOVES.TACKLE], 52), makePokemon('meowth', 'MEOWTH', 24, 'normal', [MOVES.TACKLE, MOVES.TACKLE], 52), makePokemon('meowth', 'MEOWTH', 24, 'normal', [MOVES.TACKLE, MOVES.TACKLE], 52)] },
      { id: 'lass_kanto_overworld_14', name: 'CHICA', type: 'npc', position: w('ROUTE_8', 46, 13), direction: 'down', trainerClass: 'lass', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('pidgey', 'PIDGEY', 19, 'normal', [MOVES.TACKLE, MOVES.GUST], 16, { types: ['normal', 'flying'] }), makePokemon('rattata', 'RATTATA', 19, 'normal', [MOVES.TACKLE, MOVES.TACKLE], 19), makePokemon('nidoran-m', 'NIDORAN_M', 19, 'poison', [MOVES.POISON_POWDER, MOVES.TACKLE], 32), makePokemon('meowth', 'MEOWTH', 19, 'normal', [MOVES.TACKLE, MOVES.TACKLE], 52), makePokemon('pikachu', 'PIKACHU', 19, 'electric', [MOVES.THUNDERSHOCK, MOVES.TACKLE], 25)] },
      ...
      // ── Route 9 / 16 gap filler trainers (placed on walkable tiles) ──
      { id: 'jrtrainerf_kanto_overworld_8', name: 'ENTRENADORA', type: 'npc', position: w('ROUTE_9', 13, 10), direction: 'right', trainerClass: 'cooltrainer_f', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('oddish', 'ODDISH', 18, 'grass', [MOVES.VINE_WHIP, MOVES.POISON_POWDER], 43, { types: ['grass', 'poison'] }), makePokemon('bellsprout', 'BELLSPROUT', 18, 'grass', [MOVES.VINE_WHIP, MOVES.POISON_POWDER], 69, { types: ['grass', 'poison'] }), makePokemon('oddish', 'ODDISH', 18, 'grass', [MOVES.VINE_WHIP, MOVES.POISON_POWDER], 43, { types: ['grass', 'poison'] }), makePokemon('bellsprout', 'BELLSPROUT', 18, 'grass', [MOVES.VINE_WHIP, MOVES.POISON_POWDER], 69, { types: ['grass', 'poison'] })] },
      { id: 'jrtrainerm_kanto_overworld_9', name: 'ENTRENADOR', type: 'npc', position: w('ROUTE_9', 22, 2), direction: 'left', trainerClass: 'cooltrainer_m', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('growlithe', 'GROWLITHE', 21, 'fire', [MOVES.EMBER, MOVES.TACKLE], 58), makePokemon('charmander', 'CHARMANDER', 21, 'fire', [MOVES.EMBER, MOVES.TACKLE], 4)] },
      { id: 'jrtrainerm_kanto_overworld_10', name: 'ENTRENADOR', type: 'npc', position: w('ROUTE_9', 24, 7), direction: 'down', trainerClass: 'cooltrainer_m', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('rattata', 'RATTATA', 19, 'normal', [MOVES.TACKLE, MOVES.TACKLE], 19), makePokemon('diglett', 'DIGLETT', 19, 'ground', [MOVES.DIG, MOVES.TACKLE], 50), makePokemon('ekans', 'EKANS', 19, 'poison', [MOVES.POISON_POWDER, MOVES.TACKLE], 23), makePokemon('sandshrew', 'SANDSHREW', 19, 'ground', [MOVES.DIG, MOVES.TACKLE], 27)] },
      { id: 'jrtrainerf_kanto_overworld_9', name: 'ENTRENADORA', type: 'npc', position: w('ROUTE_9', 31, 7), direction: 'left', trainerClass: 'cooltrainer_f', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('meowth', 'MEOWTH', 23, 'normal', [MOVES.TACKLE, MOVES.TACKLE], 52)] },
      { id: 'hiker_kanto_overworld_8', name: 'MONTAÑERO', type: 'npc', position: w('ROUTE_9', 43, 3), direction: 'down', trainerClass: 'hiker', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('geodude', 'GEODUDE', 21, 'rock', [MOVES.ROCK_THROW, MOVES.DIG], 74, { types: ['rock', 'ground'] }), makePokemon('onix', 'ONIX', 21, 'rock', [MOVES.ROCK_THROW, MOVES.DIG], 95, { types: ['rock', 'ground'] })] },
      { id: 'bugcatcher_kanto_overworld_15', name: 'CAZABICHOS', type: 'npc', position: w('ROUTE_9', 40, 8), direction: 'down', trainerClass: 'bugcatcher', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('beedrill', 'BEEDRILL', 19, 'bug', [MOVES.POISON_POWDER, MOVES.TACKLE], 15, { types: ['bug', 'poison'] }), makePokemon('beedrill', 'BEEDRILL', 19, 'bug', [MOVES.POISON_POWDER, MOVES.TACKLE], 15, { types: ['bug', 'poison'] })] },
      { id: 'hiker_kanto_overworld_9', name: 'MONTAÑERO', type: 'npc', position: w('ROUTE_9', 48, 8), direction: 'right', trainerClass: 'hiker', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('geodude', 'GEODUDE', 21, 'rock', [MOVES.ROCK_THROW, MOVES.DIG], 74, { types: ['rock', 'ground'] }), makePokemon('onix', 'ONIX', 21, 'rock', [MOVES.ROCK_THROW, MOVES.DIG], 95, { types: ['rock', 'ground'] })] },
      { id: 'bugcatcher_kanto_overworld_16', name: 'CAZABICHOS', type: 'npc', position: w('ROUTE_9', 45, 15), direction: 'down', trainerClass: 'bugcatcher', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('caterpie', 'CATERPIE', 20, 'bug', [MOVES.STRING_SHOT, MOVES.TACKLE], 10), makePokemon('weedle', 'WEEDLE', 20, 'bug', [MOVES.POISON_POWDER, MOVES.TACKLE], 13, { types: ['bug', 'poison'] }), makePokemon('venonat', 'VENONAT', 20, 'bug', [MOVES.POISON_POWDER, MOVES.TACKLE], 48, { types: ['bug', 'poison'] })] },
      { id: 'cueball_kanto_overworld_9', name: 'GOLFO', type: 'npc', position: w('ROUTE_16', 3, 12), direction: 'down', trainerClass: 'gambler', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('mankey', 'MANKEY', 29, 'fighting', [MOVES.DOUBLE_KICK, MOVES.TACKLE], 56), makePokemon('machop', 'MACHOP', 29, 'fighting', [MOVES.DOUBLE_KICK, MOVES.TACKLE], 66)] },
      { id: 'biker_kanto_overworld_15', name: 'MOTORISTA', type: 'npc', position: w('ROUTE_16', 11, 12), direction: 'left', trainerClass: 'biker', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('weezing', 'WEEZING', 33, 'poison', [MOVES.POISON_POWDER, MOVES.TACKLE], 110)] },
      { id: 'biker_kanto_overworld_16', name: 'MOTORISTA', type: 'npc', position: w('ROUTE_16', 17, 12), direction: 'right', trainerClass: 'biker', dialogue: ['\u00A1Prep\u00E1rate para luchar!'], isTrainer: true, trainerTeam: [makePokemon('grimer', 'GRIMER', 26, 'poison', [MOVES.POISON_POWDER, MOVES.TACKLE], 88), makePokemon('grimer', 'GRIMER', 26, 'poison', [MOVES.POISON_POWDER, MOVES.TACKLE], 88), makePokemon('grimer', 'GRIMER', 26, 'poison', [MOVES.POISON_POWDER, MOVES.TACKLE], 88), makePokemon('grimer', 'GRIMER', 26, 'poison', [MOVES.POISON_POWDER, MOVES.TACKLE], 88)] },
