import { type Pokemon, type PokemonSummary, type BaseStats, type Move } from '../types';
import { calcHp } from '../lib/damage';
import { MOVES, LEARNSET_DATABASE } from './moves';
...
export function makePokemon(
  ...
  return {
    ...
    evolutionLevel: extra?.evolutionLevel ?? EVOLUTION_RULES[id]?.evolutionLevel,
    evolvesTo: extra?.evolvesTo ?? EVOLUTION_RULES[id]?.evolvesTo,
    ...extra,
  };
}

/** Source-form → evolution rule. Lets makePokemon auto-attach evolution
 *  data so wild-spawned and trainer-party Pokémon evolve correctly without
 *  every call site needing to spell out evolutionLevel/evolvesTo. */
export const EVOLUTION_RULES: Record<string, { evolutionLevel: number; evolvesTo: string }> = {
  bulbasaur:  { evolutionLevel: 16, evolvesTo: 'ivysaur' },
  ivysaur:    { evolutionLevel: 32, evolvesTo: 'venusaur' },
  charmander: { evolutionLevel: 16, evolvesTo: 'charmeleon' },
  charmeleon: { evolutionLevel: 36, evolvesTo: 'charizard' },
  squirtle:   { evolutionLevel: 16, evolvesTo: 'wartortle' },
  wartortle:  { evolutionLevel: 36, evolvesTo: 'blastoise' },
  caterpie:   { evolutionLevel: 7,  evolvesTo: 'metapod' },
  metapod:    { evolutionLevel: 10, evolvesTo: 'butterfree' },
  weedle:     { evolutionLevel: 7,  evolvesTo: 'kakuna' },
  kakuna:     { evolutionLevel: 10, evolvesTo: 'beedrill' },
  pidgey:     { evolutionLevel: 18, evolvesTo: 'pidgeotto' },
  pidgeotto:  { evolutionLevel: 36, evolvesTo: 'pidgeot' },
  rattata:    { evolutionLevel: 20, evolvesTo: 'raticate' },
  spearow:    { evolutionLevel: 20, evolvesTo: 'fearow' },
  ekans:      { evolutionLevel: 22, evolvesTo: 'arbok' },
  sandshrew:  { evolutionLevel: 22, evolvesTo: 'sandslash' },
  'nidoran-f': { evolutionLevel: 16, evolvesTo: 'nidorina' },
  nidorina:   { evolutionLevel: 32, evolvesTo: 'nidoqueen' },
  'nidoran-m': { evolutionLevel: 16, evolvesTo: 'nidorino' },
  nidorino:   { evolutionLevel: 32, evolvesTo: 'nidoking' },
  zubat:      { evolutionLevel: 22, evolvesTo: 'golbat' },
  oddish:     { evolutionLevel: 21, evolvesTo: 'gloom' },
  paras:      { evolutionLevel: 24, evolvesTo: 'parasect' },
  venonat:    { evolutionLevel: 31, evolvesTo: 'venomoth' },
  diglett:    { evolutionLevel: 26, evolvesTo: 'dugtrio' },
  meowth:     { evolutionLevel: 28, evolvesTo: 'persian' },
  psyduck:    { evolutionLevel: 33, evolvesTo: 'golduck' },
  mankey:     { evolutionLevel: 28, evolvesTo: 'primeape' },
  growlithe:  { evolutionLevel: 36, evolvesTo: 'arcanine' },
  poliwag:    { evolutionLevel: 25, evolvesTo: 'poliwhirl' },
  poliwhirl:  { evolutionLevel: 36, evolvesTo: 'poliwrath' },
  abra:       { evolutionLevel: 16, evolvesTo: 'kadabra' },
  kadabra:    { evolutionLevel: 16, evolvesTo: 'alakazam' },
  machop:     { evolutionLevel: 28, evolvesTo: 'machoke' },
  machoke:    { evolutionLevel: 36, evolvesTo: 'machamp' },
  bellsprout: { evolutionLevel: 21, evolvesTo: 'weepinbell' },
  weepinbell: { evolutionLevel: 21, evolvesTo: 'victreebel' },
  tentacool:  { evolutionLevel: 30, evolvesTo: 'tentacruel' },
  geodude:    { evolutionLevel: 25, evolvesTo: 'graveler' },
  graveler:   { evolutionLevel: 36, evolvesTo: 'golem' },
  ponyta:     { evolutionLevel: 40, evolvesTo: 'rapidash' },
  slowpoke:   { evolutionLevel: 37, evolvesTo: 'slowbro' },
  magnemite:  { evolutionLevel: 30, evolvesTo: 'magneton' },
  doduo:      { evolutionLevel: 31, evolvesTo: 'dodrio' },
  seel:       { evolutionLevel: 34, evolvesTo: 'dewgong' },
  grimer:     { evolutionLevel: 38, evolvesTo: 'muk' },
  shellder:   { evolutionLevel: 30, evolvesTo: 'cloyster' },
  gastly:     { evolutionLevel: 25, evolvesTo: 'haunter' },
  haunter:    { evolutionLevel: 25, evolvesTo: 'gengar' },
  drowzee:    { evolutionLevel: 26, evolvesTo: 'hypno' },
  krabby:     { evolutionLevel: 28, evolvesTo: 'kingler' },
  voltorb:    { evolutionLevel: 30, evolvesTo: 'electrode' },
  exeggcute:  { evolutionLevel: 30, evolvesTo: 'exeggutor' },
  cubone:     { evolutionLevel: 28, evolvesTo: 'marowak' },
  koffing:    { evolutionLevel: 35, evolvesTo: 'weezing' },
  rhyhorn:    { evolutionLevel: 42, evolvesTo: 'rhydon' },
  horsea:     { evolutionLevel: 32, evolvesTo: 'seadra' },
  goldeen:    { evolutionLevel: 33, evolvesTo: 'seaking' },
  staryu:     { evolutionLevel: 30, evolvesTo: 'starmie' },
  magikarp:   { evolutionLevel: 20, evolvesTo: 'gyarados' },
  eevee:      { evolutionLevel: 25, evolvesTo: 'vaporeon' },
  omanyte:    { evolutionLevel: 40, evolvesTo: 'omastar' },
  kabuto:     { evolutionLevel: 40, evolvesTo: 'kabutops' },
  dratini:    { evolutionLevel: 30, evolvesTo: 'dragonair' },
  dragonair:  { evolutionLevel: 55, evolvesTo: 'dragonite' },
};
