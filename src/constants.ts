...
export const MOVES: Record<string, Move> = {
  ...
  BIND:            move('ATADURA', 'normal'  ,  15,  85,  20),
  ...
  CLAMP:           move('TENAZA', 'water'   ,  35,  85,  10),
  ...
  FIRE_SPIN:       move('GIRO FUEGO', 'fire'    ,  15,  70,  15),
  ...
  SUPER_FANG:      move('SUPER COLMIL.', 'normal'  ,   1,  90,  10),
  ...
  WRAP:            move('REPETICIÓN', 'normal'  ,  15,  90,  20),
};
