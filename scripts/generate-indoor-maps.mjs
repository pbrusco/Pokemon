...
const MAP_ID_TO_FIRERED = {
  ...
  INDIGO_PLATEAU_LOBBY: { layout: 'LAYOUT_INDIGO_PLATEAU_POKEMON_CENTER_1F', map: 'MAP_INDIGO_PLATEAU_POKEMON_CENTER_1F' },
  ELITE_FOUR_LORELEI:   { layout: 'LAYOUT_POKEMON_LEAGUE_LORELEIS_ROOM',   map: 'MAP_POKEMON_LEAGUE_LORELEIS_ROOM' },
  ELITE_FOUR_BRUNO:     { layout: 'LAYOUT_POKEMON_LEAGUE_BRUNOS_ROOM',     map: 'MAP_POKEMON_LEAGUE_BRUNOS_ROOM' },
  ELITE_FOUR_AGATHA:    { layout: 'LAYOUT_POKEMON_LEAGUE_AGATHAS_ROOM',    map: 'MAP_POKEMON_LEAGUE_AGATHAS_ROOM' },
  ELITE_FOUR_LANCE:     { layout: 'LAYOUT_POKEMON_LEAGUE_LANCES_ROOM',     map: 'MAP_POKEMON_LEAGUE_LANCES_ROOM' },
  ELITE_FOUR_CHAMPION:  { layout: 'LAYOUT_POKEMON_LEAGUE_CHAMPIONS_ROOM',  map: 'MAP_POKEMON_LEAGUE_CHAMPIONS_ROOM' },
  HALL_OF_FAME:         { layout: 'LAYOUT_POKEMON_LEAGUE_HALL_OF_FAME',    map: 'MAP_POKEMON_LEAGUE_HALL_OF_FAME' },
